...
var showArticles = $(() => {
        ...
        <div class="content__articles--post--title">
          ...
          <picture class="content__articles--post--avatar" style="display:flex;align-items:center;">
            ...
            <a href=":profile:" target="_blank" class="content__articles--post--link">
              <figcaption style="display:block;outline:none;font-size:70%;color:grey;"><span style="font-weight:700;">:author:</span> | <i class="fa fa-tag"></i> :category:, <i class="fa fa-tag"></i> :category2:</figcaption>
            </a>
          </picture>
        </div>
  ...
  $.ajax('https://public-api.wordpress.com/rest/v1.1/sites/alexballera.com/posts/')
      .then((articles) => {
        $projectContainer.find('.loader').remove()
