  ...
  <div className="${NavItems.id.home}-section grey lighten-5">
    ...
    <div className="section scrollspy">
      <div className="${NavItems.id.home}-section-title">
        <h2 className="flow-text">Seccion 2</h2>
      </div>
